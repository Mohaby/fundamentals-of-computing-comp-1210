...
*/
  ...
  */
   ...
   public void addDecagonalPrism(String s1In, double s2In, double s3In) {
   DecagonalPrism d = new DecagonalPrism(s1In, s2In, s3In);
   dList.add(d);
   ...
   public DecagonalPrism editDecagonalPrism(String labelIn, double edgeIn, double heightIn) {
