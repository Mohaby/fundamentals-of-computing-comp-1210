...
public class TriangularPrismTest {
  ...
  /**. test Set edge. **/
   ...
   /**.
     *test equalsTetrahedronFalseTest()
     */
   @Test
     public void equalsTetrahedronFalseTest() {
       TriangularPrism t = new TriangularPrism("Small Example", 1.8, 3.25);
   ...
   @Test
     public void compareToTest1() {
      ...
      t1.volume();
      TriangularPrism t2 = new TriangularPrism("Medium Exmalpe", 10.7, 25.4);
      t2.volume();
